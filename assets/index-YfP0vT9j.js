...
void main() {
    ...
    `,e.appendChild(this.container)}setCallbacks(e,t,n){this.onStart=e,this.onRestart=t,this.onResume=n}showTitle(){let e=this.container.querySelector(`#menu-content`);e.innerHTML=`
    ...
    `,e.querySelector(`#btn-start`)?.addEventListener(`click`,()=>this.onStart?.()),this.show()}showGameOver(e,t,n){let r=this.container.querySelector(`#menu-content`);r.innerHTML=`
